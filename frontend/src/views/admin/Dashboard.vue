  ...
  <div>
    ...
    <template v-else-if="data">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div
          class="card p-6 cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all"
          @click="goTo('/admin/posts')"
        >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card p-6">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-bold text-slate-800 dark:text-slate-100">最近文章</h2>
            <button
              @click="goTo('/admin/posts')"
          ...
          <div class="space-y-4">
            <div
              ...
              :key="post.id"
              class="flex items-center justify-between py-2 border-b border-slate-100 dark:border-slate-700 last:border-0 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 -mx-2 px-2 rounded"
              @click="goTo('/admin/posts/' + post.id + '/edit')"
            >
        ...
        <div class="card p-6">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-bold text-slate-800 dark:text-slate-100">最近评论</h2>
            <button
              @click="goTo('/admin/comments')"
              class="text-sm text-primary-500 hover:text-primary-600"
            >
          ...
          <div class="space-y-4">
            <div
              ...
              :key="comment.id"
              class="py-2 border-b border-slate-100 dark:border-slate-700 last:border-0 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 -mx-2 px-2 rounded"
              @click="goTo('/admin/comments')"
            >
